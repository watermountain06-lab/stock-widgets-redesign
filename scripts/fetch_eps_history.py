...
KNOWN_SPLITS = {
    ...
    "QCOM": [],   # Qualcomm has never split within this data's XBRL window. Its last and only recent split was the 2-for-1 declared 2004-07-13 (record 2004-07-23, non-taxable stock dividend distributed 2004-08-13, split-adjusted trading from 2004-08-16, per QUALCOMM's own FY2004 8-K exhibit 99.1, accn 0000936392-04-000767); the three before it were 1994-02-24 (2-for-1), 1999-05-11 (2-for-1) and 1999-12-31 (4-for-1), cumulative 32-to-1, and nothing since 2004. That predates QCOM's XBRL EarningsPerShareDiluted history entirely (earliest end 2007-09-30) as well as this data's 5y price window (from 2021-09-13). Confirmed empirically 2026-09-13 against the full XBRL duplicate-ratio sweep: 319 entries across 123 (start,end) period groups, and ZERO groups carry a duplicate-value ratio >1.3 anywhere in the series -- no retroactive per-share restatement of any kind. Cross-checked against the price series as well: the largest single-day moves in the whole 5y window are +15.2% on 2025-04-09, +15.1% on 2026-04-30 and +12.7% on 2021-11-04, all ordinary earnings/macro reactions, with no discontinuity resembling a split at any point.
    "STX": [],    # Seagate has never split within this data's XBRL window, and the sweep here is one of the cleanest on this list. Confirmed empirically 2026-09-13 against the full XBRL duplicate-ratio sweep: EarningsPerShareDiluted has 212 entries across 104 (start,end) period groups running back to end 2009-07-03, and ZERO groups disagree at all -- not zero above 1.3x, zero disagreements of any size. WeightedAverageNumberOfDilutedSharesOutstanding is identical (212 entries, 104 groups, 0 disagreements), which is the tag that settled CRWD's ambiguous ratio above. With no restatement anywhere in the series there is nothing for a split ratio to hide behind. Seagate's last true split was the 2-for-1 in 2006 under the predecessor Cayman entity, far outside both this data's 5y price window (from 2021-09-13) and the XBRL history. The 2021 redomiciliation from Seagate Technology plc to Seagate Technology Holdings plc (this CIK) was a scheme of arrangement exchanging shares 1-for-1, NOT a proportional split -- the same corporate-action-versus-split distinction already documented for MRVL's Inphi/Delaware reorganization, DELL's VMware Class V exchange and SNDK's Western Digital spin-off above, and a 1-for-1 exchange leaves every per-share figure unmoved, which is exactly what the zero-disagreement sweep shows. Cross-checked against the price series as well: the largest single-day moves in the whole 5y window are +19.1% on 2026-01-28, +19.1% on 2025-10-29 and -16.4% on 2025-04-03, all ordinary earnings/tariff reactions, with no discontinuity resembling a split at any point.
}
